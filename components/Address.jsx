...
export default function Address() {
  return (
    <div className="bg-dotted-spacing-8  flex justify-center content-center w-full bg-zinc-800 opacity-90">
      <div className="w-full  lg:w-2/3 2xl:w-1/2 px-8 lg:px-0 my-32 ">
        ...
        <div className="lg:mx-16 bg-gray-100 mb-7 flex-row addressContainer bg-transparent">
          <div className="  flex-col addressCard bg-zinc-900 opacity-90  text-gray-300 ">
